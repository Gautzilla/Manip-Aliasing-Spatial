...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 617.5, 398.0, 209.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 547.0, 397.0, 61.0, 22.0 ],
					"text" : "delay 100"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 547.0, 369.0, 31.0, 22.0 ],
					"text" : "t b s"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 547.0, 427.0, 78.0, 22.0 ],
					"text" : "sprintf %s%s"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 547.0, 454.0, 57.0, 22.0 ],
					"text" : "tosymbol"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 547.0, 486.0, 80.0, 22.0 ],
					"text" : "prepend read"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 547.0, 345.0, 56.0, 22.0 ],
					"text" : "r filePath"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 224.0, 775.20001220703125, 58.0, 22.0 ],
					"text" : "s filePath"
				}
...
,
					"patching_rect" : [ 107.0, 739.0, 136.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 117.5, 669.0, 51.0, 22.0 ],
					"text" : "r nLines"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 117.5, 545.0, 53.0, 22.0 ],
					"text" : "s nLines"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "", "", "", "", "" ],
					"patching_rect" : [ 61.5, 599.0, 164.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 61.5, 316.0, 71.0, 22.0 ],
					"text" : "r userName"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 107.0, 702.0, 29.5, 22.0 ],
					"text" : "sel"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 61.5, 635.0, 31.0, 22.0 ],
					"text" : "t b s"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "int", "", "", "int" ],
					"patching_rect" : [ 107.0, 635.0, 61.0, 22.0 ],
					"text" : "counter"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 105.0, 470.0, 39.0, 22.0 ],
					"text" : "query"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 61.5, 434.0, 42.0, 22.0 ],
					"text" : "t b b 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "cr" ],
					"patching_rect" : [ 61.5, 560.5999755859375, 34.0, 22.0 ],
					"text" : "t s cr"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "bang", "int" ],
					"patching_rect" : [ 77.0, 784.0, 40.0, 22.0 ],
					"text" : "text",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 61.5, 470.0, 39.0, 22.0 ],
					"text" : "dump"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "bang", "int" ],
					"patching_rect" : [ 61.5, 508.0, 75.0, 22.0 ],
					"text" : "text Train.txt"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 447.0, 441.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 447.0, 475.0, 44.0, 22.0 ],
					"text" : "line $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "bang", "int" ],
					"patching_rect" : [ 447.0, 511.0, 40.0, 22.0 ],
					"text" : "text"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 424.0, 244.399993896484375, 627.0, 586.0 ],
					"proportion" : 0.5,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 148.0, 509.0, 106.0, 20.0 ],
					"suppressinlet" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 9.0, 244.399993896484375, 317.0, 586.0 ],
					"proportion" : 0.5,
					"prototypename" : "backgroundPanel"
				}
