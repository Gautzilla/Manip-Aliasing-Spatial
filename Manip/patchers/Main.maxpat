...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 388.5, 463.0, 37.0, 22.0 ],
					"text" : "s test"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 388.5, 435.0, 34.0, 22.0 ],
					"text" : "sel 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 388.5, 406.5, 69.0, 22.0 ],
					"text" : "var session"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 388.5, 378.0, 57.0, 22.0 ],
					"text" : "r testEnd"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 327.5, 276.0, 73.0, 22.0 ],
					"text" : "s userName"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 263.5, 76.0, 29.5, 22.0 ],
					"text" : "1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 263.5, 48.5, 61.0, 22.0 ],
					"text" : "r trainEnd"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 331.5, 378.0, 35.0, 22.0 ],
					"text" : "r test"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 263.5, 105.0, 57.0, 22.0 ],
					"text" : "active $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 125.0, 105.0, 57.0, 22.0 ],
					"text" : "active $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 125.0, 132.5, 123.0, 22.0 ],
					"text" : "pvar btnEntrainement"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 263.5, 132.5, 75.0, 22.0 ],
					"text" : "pvar btnTest"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 289.4705810546875, 19.0, 166.0, 21.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 150.0, 108.0, 136.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 263.5, 276.0, 59.0, 22.0 ],
					"text" : "s runTest"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 125.0, 164.0, 88.0, 22.0 ],
					"text" : "s entrainement"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 125.0, 71.0, 32.0, 22.0 ],
					"text" : "t 1 0"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 119.0, 19.0, 648.4705810546875, 289.0 ],
					"proportion" : 0.5,
					"prototypename" : "backgroundPanel"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 14.0, 19.0, 100.0, 85.0 ],
					"proportion" : 0.5,
					"prototypename" : "backgroundPanel"
				}
...
, 			{
				"name" : "var.maxpat",
				"bootpath" : "~/AppData/Roaming/Cycling '74/Max 8/examples/max-tricks/send-receive-tricks/lib",
				"patcherrelativepath" : "../../../../../../../AppData/Roaming/Cycling '74/Max 8/examples/max-tricks/send-receive-tricks/lib",
				"type" : "JSON",
				"implicit" : 1
			}
 ],
